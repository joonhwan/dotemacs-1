...
* Manage frames with EXWM
While I was very happy with dwm on Arch, I thought it would be interesting to make my workflow even more Emacs-centric. =EXWM= or the [[https://github.com/ch11ng/exwm][Emacs X Windows Manager]] is a tiling window manager built into Emacs. 
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; This is a clunky solution that is no longer relevant with EXWM.
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Org-journal is a great package, but I have switched to using dash.
...
** Take notes with Deft
[[https://jblevins.org/projects/deft/][Deft]] is a note taking and management package inspired by Notational Velocity. The [[http://pragmaticemacs.com/emacs/make-quick-notes-with-deft/][following setup]] forces Deft to use Org in notes.
...
When editing JSON files, =json-mode= adds some helpful features.
